...
<title>SRM</title>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/member/signupForm.css"/>
	 ...
	 <!-- JavaScript 파일 로드 -->
    <script src="${pageContext.request.contextPath}/resources/js/updateOptions.js" defer></script>
</body>
                ...
                <div id="right-side">
	 			...
	 			<div id="left-side">
	                    <div class="select-div">
	                     ...
	                     <div class="select-div">
	                        <label>기관</label>
	                        <select name="instId" id="instId" class="form-select">
