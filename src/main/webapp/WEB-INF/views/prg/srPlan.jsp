...
<div id="title">
   ...
   <div class="tabs-container d-flex align-items-center">
   	<ul class="nav nav-tabs">
       	<li class="nav-item">
			<a id="sr-plan-tab" class="nav-link pg-tab active" data-bs-toggle="tab" data-appsrid="${srPlan.appSrId}">SR계획정보</a>
		</li>
           <li class="nav-item">
               <a id="sr-hr-tab" class="nav-link pg-tab" data-bs-toggle="tab" data-appsrid="${srPlan.appSrId}">SR자원정보</a>
           </li>
           <li class="nav-item">
               <a id="sr-ratio-tab" class="nav-link pg-tab" data-bs-toggle="tab" data-appsrid="${srPlan.appSrId}">SR진척율</a>
           </li>
        </ul>
</div>
<div id="sr-container">
