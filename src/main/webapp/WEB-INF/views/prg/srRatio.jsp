...
<div id="pg-table-container">
    <table id="pg-table">
        ...
        <tbody>
        	<c:forEach items="${prgRatioList}" var="prgRatio">
	            <tr>
	                <td class="pg-col-1">${prgRatio.rnum}</td>
	                <td class="pg-col-2">${prgRatio.tastTName}</td>
	                <td class="pg-col-3">${prgRatio.stDt}</td>
	                <td class="pg-col-4">${prgRatio.endDt}</td>
	                <td class="pg-col-5">${prgRatio.prg}</td>
	            </tr>
        	</c:forEach>
<!--             <tr>
