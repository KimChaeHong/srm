							...
							<tr>
								...
								<td>
									<div class="action-buttons">
										<a href="${pageContext.request.contextPath}/myportal/noticeDetail/${notice.noticeId}" 
											class="btn-edit">수정</a>
										<a href="${pageContext.request.contextPath}/myportal/deleteNotice/${notice.noticeId}"
